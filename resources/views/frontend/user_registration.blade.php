                                            ...
                                            <form id="reg-form" class="form-default" role="form" action="{{ route('register') }}" method="POST">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <button class="btn btn-outline-primary" type="button" id="dni-lookup-btn" onclick="lookupDNIFromElement(document.getElementById('dni'), document.querySelector('input[name=name]'))">{{ translate('Lookup') }}</button>
                                                    </div>
                                                </div>
