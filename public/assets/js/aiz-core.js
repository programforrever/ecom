    ...
    AIZ.plugins = {
        ...
        countDownCircle: function () {
            let html =  '<div id="time"><div class="circle"><svg><circle cx="30" cy="30" r="30"></circle><circle cx="30" cy="30" r="30" id="dd"></circle></svg><div id="days">00 <br><span>Dias</span></div></div>' +
                        '<div class="circle"><svg><circle cx="30" cy="30" r="30"></circle><circle cx="30" cy="30" r="30" id="hh"></circle></svg><div id="hours">00 <br><span>Horas</span></div></div>' +
                ...
                $('.aiz-count-down-circle').each(function(){
                    ...
                    let x = setInterval(function(){
                        ...
                        if(distance > 0){
                            ...
                            hours.html(h + '<br><span>Horas</span>');
