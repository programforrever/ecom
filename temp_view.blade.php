				...
				<div class="tab-content">
								...
								<div class="w-100">
									...
									<div class="home-slider-target">
										@php 
											...
											$home_slider_tags = get_setting('home_slider_tags', null, $lang);
											$home_slider_old_prices = get_setting('home_slider_old_prices', null, $lang);
											$home_slider_titles = get_setting('home_slider_titles', null, $lang);
											$home_slider_new_prices = get_setting('home_slider_new_prices', null, $lang);
											$home_slider_btn_texts = get_setting('home_slider_btn_texts', null, $lang);
											$home_slider_anim_direction = get_setting('home_slider_anim_direction', null, $lang);
											$slider_tags = $home_slider_tags ? json_decode($home_slider_tags, true) : [];
											$slider_old_prices = $home_slider_old_prices ? json_decode($home_slider_old_prices, true) : [];
											$slider_titles = $home_slider_titles ? json_decode($home_slider_titles, true) : [];
											$slider_new_prices = $home_slider_new_prices ? json_decode($home_slider_new_prices, true) : [];
											$slider_btn_texts = $home_slider_btn_texts ? json_decode($home_slider_btn_texts, true) : [];
											$slider_anim_directions = $home_slider_anim_direction ? json_decode($home_slider_anim_direction, true) : [];
										@endphp
											...
											@foreach (json_decode($home_slider_images, true) as $key => $value)
												<div class="p-3 p-md-4 mb-3 mb-md-2rem remove-parent" style="border: 1px dashed #e4e5eb;">
													<div class="row gutters-5">
														...
														<div class="col-md-3">
															<div class="form-group mb-md-0">
																<label class="d-block mb-2">{{ translate('Image') }}</label>
														...
														<div class="col-md-2">
															<div class="form-group mb-md-0">
																<label class="d-block mb-2">{{ translate('Tag') }}</label>
																<input type="hidden" name="types[]" value="home_slider_tags">
																<input type="text" class="form-control" placeholder="{{ translate('Special Offer') }}" name="home_slider_tags[]" value="{{ $slider_tags[$key] ?? translate('Special Offer') }}">
															</div>
														</div>
														<!-- Title -->
														<div class="col-md-2">
															<div class="form-group mb-md-0">
																<label class="d-block mb-2">{{ translate('Title') }}</label>
																<input type="hidden" name="types[]" value="home_slider_titles">
																<input type="text" class="form-control" placeholder="{{ translate('Product Name') }}" name="home_slider_titles[]" value="{{ $slider_titles[$key] ?? '' }}">
															</div>
														</div>
														<!-- Old Price -->
														<div class="col-md-2">
															<div class="form-group mb-md-0">
																<label class="d-block mb-2">{{ translate('Old Price') }}</label>
																<input type="hidden" name="types[]" value="home_slider_old_prices">
																<input type="text" class="form-control" placeholder="$99.99" name="home_slider_old_prices[]" value="{{ $slider_old_prices[$key] ?? '' }}">
															</div>
														</div>
														<!-- New Price -->
														<div class="col-md-2">
															<div class="form-group mb-md-0">
																<label class="d-block mb-2">{{ translate('New Price') }}</label>
																<input type="hidden" name="types[]" value="home_slider_new_prices">
																<input type="text" class="form-control" placeholder="$49.99" name="home_slider_new_prices[]" value="{{ $slider_new_prices[$key] ?? '' }}">
															</div>
														</div>
													</div>
													<div class="row gutters-5 mt-2">
														...
														<div class="col-md-4">
															<div class="form-group mb-md-0">
																<label class="d-block mb-2">{{ translate('Link') }}</label>
														...
														<div class="col-md-4">
															<div class="form-group mb-md-0">
																<label class="d-block mb-2">{{ translate('Button Text') }}</label>
																<input type="hidden" name="types[]" value="home_slider_btn_texts">
																<input type="text" class="form-control" placeholder="{{ translate('Shop Now') }}" name="home_slider_btn_texts[]" value="{{ $slider_btn_texts[$key] ?? translate('Shop Now') }}">
															</div>
														</div>
														<!-- Animation Direction -->
														<div class="col-md-3">
															<div class="form-group mb-md-0">
																<label class="d-block mb-2">{{ translate('Image Animation') }}</label>
																<input type="hidden" name="types[]" value="home_slider_anim_direction">
																<select class="form-control" name="home_slider_anim_direction[]">
																	<option value="right-to-left" @if(($slider_anim_directions[$key] ?? 'right-to-left') == 'right-to-left') selected @endif>{{ translate('Right to Left') }}</option>
																	<option value="left-to-right" @if(($slider_anim_directions[$key] ?? '') == 'left-to-right') selected @endif>{{ translate('Left to Right') }}</option>
																	<option value="bottom-to-top" @if(($slider_anim_directions[$key] ?? '') == 'bottom-to-top') selected @endif>{{ translate('Bottom to Top') }}</option>
																	<option value="top-to-bottom" @if(($slider_anim_directions[$key] ?? '') == 'top-to-bottom') selected @endif>{{ translate('Top to Bottom') }}</option>
																</select>
															</div>
														</div>
												...
												<div class="row gutters-5">
													...
													<div class="col-md-2">
														<div class="form-group mb-md-0">
															<label class="d-block mb-2">{{ translate("Tag") }}</label>
															<input type="hidden" name="types[]" value="home_slider_tags">
															<input type="text" class="form-control" placeholder="{{ translate("Special Offer") }}" name="home_slider_tags[]" value="">
														</div>
													</div>
													<!-- Title -->
													<div class="col-md-2">
														<div class="form-group mb-md-0">
															<label class="d-block mb-2">{{ translate("Title") }}</label>
															<input type="hidden" name="types[]" value="home_slider_titles">
															<input type="text" class="form-control" placeholder="{{ translate("Product Name") }}" name="home_slider_titles[]" value="">
														</div>
													</div>
													<!-- Old Price -->
													<div class="col-md-2">
														<div class="form-group mb-md-0">
															<label class="d-block mb-2">{{ translate("Old Price") }}</label>
															<input type="hidden" name="types[]" value="home_slider_old_prices">
															<input type="text" class="form-control" placeholder="$99.99" name="home_slider_old_prices[]" value="">
														</div>
													</div>
													<!-- New Price -->
													<div class="col-md-2">
														<div class="form-group mb-md-0">
															<label class="d-block mb-2">{{ translate("New Price") }}</label>
															<input type="hidden" name="types[]" value="home_slider_new_prices">
															<input type="text" class="form-control" placeholder="$49.99" name="home_slider_new_prices[]" value="">
														</div>
													</div>
												</div>
												<div class="row gutters-5 mt-2">
													...
													<div class="col-md-4">
														<div class="form-group mb-md-0">
															<label class="d-block mb-2">{{ translate("Button Text") }}</label>
															<input type="hidden" name="types[]" value="home_slider_btn_texts">
															<input type="text" class="form-control" placeholder="{{ translate("Shop Now") }}" name="home_slider_btn_texts[]" value="">
														</div>
													</div>
													<!-- Animation Direction -->
													<div class="col-md-3">
														<div class="form-group mb-md-0">
															...
															<input type="hidden" name="types[]" value="home_slider_anim_direction">
															<select class="form-control" name="home_slider_anim_direction[]">
																<option value="right-to-left">{{ translate("Right to Left") }}</option>
																<option value="left-to-right">{{ translate("Left to Right") }}</option>
																<option value="bottom-to-top">{{ translate("Bottom to Top") }}</option>
																<option value="top-to-bottom">{{ translate("Top to Bottom") }}</option>
															</select>
														</div>
													</div>
													<!-- remove parent button -->
					...
					<div class="tab-pane fade" id="flash_deal_banner" role="tabpanel" aria-labelledby="flash-deal-banner-tab">
						<form action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
							...
							<div class="bg-white p-3 p-sm-2rem">
								<div class="w-100">
									<label class="col-from-label fs-13 fw-500 mb-3">{{ translate('Flash Deal Banner') }}</label>
									<p class="fs-12 text-secondary mb-4">{{ translate('This banner appears below the Flash Sale section') }}</p>
									
									<!-- Image -->
									<div class="form-group">
										<label class="fs-12 mb-2">{{ translate('Banner Image') }} <span class="text-danger">*</span></label>
										<p class="fs-11 text-secondary mb-2">{{ translate('Recommended size: 1200 x 300 px') }}</p>
										<div class="input-group" data-toggle="aizuploader" data-type="image">
											<div class="input-group-prepend">
												<div class="input-group-text bg-soft-secondary font-weight-medium">{{ translate('Browse')}}</div>
											</div>
											<div class="form-control file-amount">{{ translate('Choose File') }}</div>
											<input type="hidden" name="types[][{{ $lang }}]" value="flash_deal_banner_image">
											<input type="hidden" name="flash_deal_banner_image[]" class="selected-files" value="{{ get_setting('flash_deal_banner_image', null, $lang) }}">
										</div>
								...
								<!-- Title -->
								<div class="form-group">
									<label class="fs-12 mb-2">{{ translate('Title') }} <span class="text-danger">*</span></label>
									<input type="hidden" name="types[]" value="flash_deal_banner_title">
									<input type="text" class="form-control" placeholder="{{ translate('Ex: Special Promotion') }}" 
										name="flash_deal_banner_title" value="{{ get_setting('flash_deal_banner_title', null, $lang) }}" required>
								</div>

								<!-- Description -->
								<div class="form-group">
									<label class="fs-12 mb-2">{{ translate('Description') }} <span class="text-danger">*</span></label>
									<input type="hidden" name="types[]" value="flash_deal_banner_description">
									<input type="text" class="form-control" placeholder="{{ translate('Ex: Get exclusive offers on selected items') }}" 
										name="flash_deal_banner_description" value="{{ get_setting('flash_deal_banner_description', null, $lang) }}" required>
								</div>

								<!-- WhatsApp Button Link -->
								<div class="form-group">
									<label class="fs-12 mb-2">{{ translate('WhatsApp Link') }} <span class="text-danger">*</span></label>
									<p class="fs-11 text-secondary mb-2">{{ translate('Ex: https://wa.me/51XXXXXXXXX or https://api.whatsapp.com/send?phone=51XXXXXXXXX') }}</p>
									<input type="hidden" name="types[]" value="flash_deal_banner_whatsapp_link">
									<input type="url" class="form-control" placeholder="https://wa.me/..." 
										name="flash_deal_banner_whatsapp_link" value="{{ get_setting('flash_deal_banner_whatsapp_link') }}" required>
								</div>

								<!-- Button Text -->
								<div class="form-group">
									<label class="fs-12 mb-2">{{ translate('Button Text') }} <span class="text-danger">*</span></label>
									<input type="hidden" name="types[]" value="flash_deal_banner_button_text">
									<input type="text" class="form-control" placeholder="{{ translate('Ex: Contact on WhatsApp') }}" 
										name="flash_deal_banner_button_text" value="{{ get_setting('flash_deal_banner_button_text', null, $lang) }}" required>
								</div>
							</div>
