...
<!-- Banner Extra Hardcoded -->
<div class="bg-white px-3 py-3 py-md-2rem mb-2 mb-md-3 banner-1-left-sidebar">
    <div class="carousel-box overflow-hidden hov-scale-img position-relative">
        <img src="https://i.pinimg.com/originals/95/38/6d/95386df547e95695c51390a6d2ef48a0.jpg"
            alt="Banner Promo"
            class="img-fluid w-100 has-transition"
            onerror="this.onerror=null;this.src='{{ static_asset('assets/img/placeholder-rect.jpg') }}';">

        <!-- Overlay de texto arriba -->
        <div class="banner-1-overlay" style="justify-content:flex-start; pointer-events:none;">
            <div class="banner-1-overlay-title" style="font-size:22px; margin-bottom:8px;">Cotiza tu prenda a medida</div>
            <div class="banner-1-overlay-desc" style="font-size:15px;">Hacemos tejidos y bordados a tu medida</div>
        </div>

        <!-- Botón WhatsApp flotante centrado -->
        <a href="https://wa.link/v0w48y" target="_blank"
            ...
            onmouseover="this.style.transform='translateX(-50%) scale(1.05)'; this.style.boxShadow='0 6px 24px rgba(37,211,102,0.7)';"
            onmouseout="this.style.transform='translateX(-50%)'; this.style.boxShadow='0 4px 18px rgba(37,211,102,0.5)';">
